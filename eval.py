...
logtostderr = './logs'
checkpoint_dir = './{}/'.format(model_dir)
eval_dir = './eval'
pipeline_cofig = './{}/pipeline.config'.format(model_dir)
...
flags.DEFINE_string(
    'pipeline_config_path', pipeline_cofig,
...
flags.DEFINE_boolean(
    'run_once', True, 'Option to only run a single pass of '
